...
- (void)setupTitleScrollView {
    ...
    CGRect rect = CGRectMake(0, y, kScreenWidth, NavigationBar_HEIGHT);
...
- (void)setupContainerScrollView {
    ...
    CGRect rect = CGRectMake(0, y, kScreenWidth, kScreenHeight - (STATUS_BAR_HEIGHT + NavigationBar_HEIGHT + y));
