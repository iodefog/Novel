...
- (void)setupUI {
    ...
    //search_refresh
    UIButton *replaceButton = [[UIButton alloc] initWithFrame:CGRectMake(kScreenWidth - 100, 0, 100, 40)];
    ...
    _searchBar = [[UISearchBar alloc] initWithFrame:CGRectMake(0, everyLabel.maxY_pro, kScreenWidth, 50)];
